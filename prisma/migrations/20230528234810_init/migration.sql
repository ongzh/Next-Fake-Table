...
CREATE TABLE "Booking" (
    ...
    "booker_phone_number" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "BookingsAtTable" (
    "booking_id" INTEGER NOT NULL,
    "table_id" INTEGER NOT NULL,

    CONSTRAINT "BookingsAtTable_pkey" PRIMARY KEY ("booking_id","table_id")
);
...
-- AddForeignKey
ALTER TABLE "BookingsAtTable" ADD CONSTRAINT "BookingsAtTable_booking_id_fkey" FOREIGN KEY ("booking_id") REFERENCES "Booking"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BookingsAtTable" ADD CONSTRAINT "BookingsAtTable_table_id_fkey" FOREIGN KEY ("table_id") REFERENCES "Table"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
